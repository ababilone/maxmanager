...
namespace MaxManager.Services.Settings
{
	public class SettingService : ISettingService
	{
		...
		public bool IsDiscoveryEnabled
		{
			...
			set { _roamingSettings.Values[nameof(IsDiscoveryEnabled)] = value; }
		}

		public int DiscoveryTimeOut
		{
			get { return Get(nameof(DiscoveryTimeOut), 1); }
			set { _roamingSettings.Values[nameof(DiscoveryTimeOut)] = value; }
		}

		public string CubeAddress
		{
			get { return Get(nameof(CubeAddress), ""); }
			set { _roamingSettings.Values[nameof(CubeAddress)] = value; }
		}

		public bool IsDebugEnabled
		{
			get { return Get(nameof(IsDebugEnabled), false); }
			set { _roamingSettings.Values[nameof(IsDebugEnabled)] = value; }
		}

		public string Theme
		{
			get { return Get(nameof(Theme), "light"); }
			set { _roamingSettings.Values[nameof(Theme)] = value; }
		}
	}
}